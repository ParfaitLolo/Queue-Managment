...
# recuperation des données de yolo =============
@app.get("/api/yolo/{camera_id}")
def yolo_data(camera_id: int):

    if camera_id not in cameras:
        return {"error": "Caméra inconnue"}

    return cameras[camera_id].get_yolo_data()
